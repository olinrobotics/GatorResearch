...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/reggert/Documents/GatorROS/GatorResearch/master_ws/src/basic_communications)
  set(beginner_tutorials_DEVEL_PREFIX /home/reggert/Documents/GatorROS/GatorResearch/master_ws/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/reggert/Documents/GatorROS/GatorResearch/master_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'reggert <reggert@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/reggert/Documents/GatorROS/GatorResearch/master_ws/src/basic_communications/${idir}'.  Ask the maintainer 'reggert <reggert@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/reggert/Documents/GatorROS/GatorResearch/master_ws/devel/lib;/opt/ros/indigo/lib)
