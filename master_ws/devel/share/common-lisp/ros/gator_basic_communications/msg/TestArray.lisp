...
(cl:defmethod cl:initialize-instance :after ((m <TestArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TestArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gator_basic_communications-msg:<TestArray> is deprecated: use gator_basic_communications-msg:TestArray instead.")))

(cl:ensure-generic-function 'testarray-val :lambda-list '(m))
(cl:defmethod testarray-val ((m <TestArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gator_basic_communications-msg:testarray-val is deprecated.  Use gator_basic_communications-msg:testarray instead.")
  (testarray m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TestArray>)))
  ...
  "gator_basic_communications/TestArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TestArray)))
  "Returns string type for a message object of type 'TestArray"
  "gator_basic_communications/TestArray")
